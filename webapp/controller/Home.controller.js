        ...
        return Controller.extend("ajpeliculas.catalogo.controller.Home", {
            ...
            onModelos3DLancamentos: function () {
                if (!this.Modelos3dLancamentos) {
                    this.Modelos3dLancamentos = sap.ui.xmlfragment("ajpeliculas.catalogo.view.fragmentos.3dLancamentos", this);
                    this.getView().addDependent(this.Modelos3d);
                } else {
                    this.Modelos3dLancamentos = ""
                    this.Modelos3dLancamentos = sap.ui.xmlfragment("ajpeliculas.catalogo.view.fragmentos.3dLancamentos", this);
                    this.getView().addDependent(this.Modelos3dLancamentos);
                }
                // open value help dialog filtered by the input value
                this.Modelos3dLancamentos.open();
            },

            Fechar3DLancamentos: function () {
                this.Modelos3dLancamentos.close();
            },

            onPrivacidade: function () {
                if (!this.ModelosPrivacidade) {
                    this.ModelosPrivacidade = sap.ui.xmlfragment("ajpeliculas.catalogo.view.fragmentos.ModelosPrivacidade", this);
                    this.getView().addDependent(this.Modelos3d);
                } else {
                    this.ModelosPrivacidade = ""
                    this.ModelosPrivacidade = sap.ui.xmlfragment("ajpeliculas.catalogo.view.fragmentos.ModelosPrivacidade", this);
                    this.getView().addDependent(this.ModelosPrivacidade);
                }
                // open value help dialog filtered by the input value
                this.ModelosPrivacidade.open();
            },

            FecharPrivacidade: function () {
                this.ModelosPrivacidade.close();
            },
