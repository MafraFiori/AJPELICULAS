		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Catalogo de preços",
									"targetURL": "#ajpeliculascatalogo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ajpeliculascatalogo-display": {
								"semanticObject": "ajpeliculascatalogo",
								"action": "display",
								"description": "Catalogo de preços",
								"title": "Catalogo de preços",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ajpeliculas.catalogo",
									"url": sap.ui.require.toUrl("ajpeliculas/catalogo")
								}
							}
						}
					}
